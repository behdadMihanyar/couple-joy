...
const Form = () => {
  ...
  return (
    <>
      <div className="overscroll-none absolute w-full h-screen bg-cover z-10 opacity-90"></div>
      <form
        onSubmit={(e) => submitHandler(e)}
        className="h-screen w-full flex flex-col justify-center content-center items-center"
      >
        <div className="max-sm:w-85 h-120 shadow-2xl shadow-black bg-gray-900/90 grid z-100 grid-cols-1 rounded-4xl p-2 lg:grid-cols-5 lg:w-200 ">
          <div></div>
          <div className="grid grid-span-4 col-span-3 p-3 content-center text-center gap-3 font-bold text-white">
            ...
            <input
              ...
              className="border-white border-2 py-2 px-3 rounded-2xl focus:scale-110 transition ease focus:bg-white/20"
            />
            <label>Family</label>
            <input
              value={select.family}
